"""
Direct test of Groq API with detailed logging
...
if not api_key:
    ...
    print("   5. Copy and paste it into .env file")
    sys.exit(1)
...
print("📋 STEP 3: Initializing Groq Client...")
print("-" * 70)
...
try:
    ...
    if "ssl" in error_str or "certificate" in error_str:
        ...
        print("   2. Update Python: brew reinstall python@3.14")
        ...
        print()
        print("   Get a new FREE key at: https://console.groq.com/keys")
        print()
        ...
        print("   - 14,400 tokens per minute")
        print()
        ...
        print("   - Groq service status: https://status.groq.com")
        print()
...
print()
print("Your Groq API integration is ready to use!")
print()
print("Groq Benefits:")
print("  • 🆓 FREE tier (no credit card required!)")
print("  • ⚡ BLAZING FAST inference (fastest in the market)")
print("  • 🔓 OpenAI-compatible API")
print("  • ✅ Works perfectly with Python 3.14")
print("  • 🚀 Generous rate limits")
print()
print("Free Tier Limits:")
print("  • 30 requests per minute")
print("  • 14,400 tokens per minute")
print("  • Perfect for development and small apps!")
print()
